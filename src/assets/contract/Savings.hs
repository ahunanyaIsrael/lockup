...
import PlutusTx (CompiledCode, compile, unsafeFromBuiltinData, unstableMakeIsData)
import PlutusTx.Prelude hiding (Show, ($), (<>))
import Prelude (FilePath, IO, Show, print, putStrLn, ($), (<>))
...
main = do
  ...
  writeValidator "./assets/time-locked-savings2.plutus" validator
